...
export function Content() {
    ...
    return (
        <>
            <div onClick={()=>change("tuan")} className={'m-2 font-medium italic'}>Topic : công nghệ thông tin</div>
            {/*<div className={'m-2'}>*/}
            {/*    DUY NHẤT TẾT THIẾU NHI 👉 MUA 3 GIẢM THÊM 10%*/}
            {/*    Thoải mái chơi Hè, bé thêm niềm vui 💥 Chương trình đặc biệt mừng Quốc Tế Thiếu Nhi 👉 𝐌𝐮𝐚 𝐭𝐮̛̀ 𝟑 𝐬𝐚̉𝐧 𝐩𝐡𝐚̂̉𝐦 𝐠𝐢𝐚̉𝐦 𝐭𝐡𝐞̂𝐦 𝟏𝟎% 𝐭𝐫𝐞̂𝐧 𝐭𝐨̂̉𝐧𝐠 𝐡𝐨́𝐚 đ𝐨̛𝐧 (*)*/}
            {/*    💸Ba mẹ ơiii, không phải đau ví mà bé lại vui nè, còn chờ gì nữa 🏃 Đến ngay Mykingdom chọn quà bé thích đi nào*/}
            {/*    ⁉️ (*) Chương trình áp dụng cho thành viên Mykingdom. Liên hệ cửa hàng hoặc Hotline 19001208 để biết thêm thông tin chi tiết*/}
            {/*    📅 Chương trình diễn ra từ 29/04/2023 - 04/06/2023, cùng theo dõi fanpage của MyKingdom để không bỏ lỡ bất kỳ thông tin nào về sự kiện cực hấp dẫn này nhé cả nhà!*/}
            {/*</div>*/}
